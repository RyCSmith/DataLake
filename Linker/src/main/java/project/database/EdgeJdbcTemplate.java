...
public class EdgeJdbcTemplate {
	...
	public void insertEdge(Integer id1, Integer id2, String type) {
		String SQL = "insert into edge_table values (?, ?, ?)";
		jdbcTemplateObject.update( SQL, id1, id2, type);
		System.out.println("Created link between node: " + id1 + " and node: " + id2);
	}
